...
/**
 * Set ops for this instance (chainable method)
 */
ViewContext.prototype.map = function(ops){
  this._viewOps = ops;
  return this;
}
 ...
 * Default ops
 */
ViewContext.prototype.__defineViewOps__({
});

/**
 * Make all context keys available as ops
 * @override Base.prototype._opKeys
 */
ViewContext.prototype._opKeys = function(){
  // Include values available on obj
  return (this._viewContext == this) ? Object.keys(this._viewOps) : Object.keys(this._viewContext).concat(Object.keys(this._viewOps));
}
 ...
 *
 * @param {Object} obj
 * @param {Object} viewOps  mapping operations, as per .map()
 * @return {ViewContext}    returns an instance of ViewContext
 */
ViewContext.create = function(obj, viewOps) {
  return new this(obj, viewOps);
}
